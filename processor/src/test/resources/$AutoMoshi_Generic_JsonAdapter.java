...
public final class $AutoMoshi_Generic_JsonAdapter<T1, T2> extends JsonAdapter<Generic<T1, T2>> {
  ...
  public $AutoMoshi_Generic_JsonAdapter(Moshi moshi, Type[] typeArgs) {
