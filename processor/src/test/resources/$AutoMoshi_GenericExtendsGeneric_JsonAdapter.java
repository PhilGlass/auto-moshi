...
public final class $AutoMoshi_GenericExtendsGeneric_JsonAdapter<T1, T2> extends
    JsonAdapter<GenericExtendsGeneric<T1, T2>> {
  ...
  public $AutoMoshi_GenericExtendsGeneric_JsonAdapter(Moshi moshi, Type[] typeArgs) {
