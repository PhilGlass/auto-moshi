...
public final class $AutoMoshi_NullableProperty_JsonAdapter extends JsonAdapter<NullableProperty> {
  private final JsonAdapter<String> aAdapter;
  private final JsonAdapter<String> bAdapter;

  public $AutoMoshi_NullableProperty_JsonAdapter(Moshi moshi) {
