...
final class AutoValue_PrefixedProperties extends $AutoValue_PrefixedProperties {
  AutoValue_PrefixedProperties(boolean a, String b) {
    super(a, b);
  }

  static final class AutoMoshi_JsonAdapter extends JsonAdapter<PrefixedProperties> {
